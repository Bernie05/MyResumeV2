...
export const resumeData: ResumeData = {
  ...
  experience: [
    {
      ...
      description: [
        ...
        "Participate in development and code review",
        "Develop system enhancements",
        "Contribute to design review and code review",
        "Document new processes and maintain and update system documentation",
        "Perform unit testing, acceptance testing, and integration testing",
        "Debug and fix software defect issues",
      ],
    },
    {
      id: 2,
      ...
      description: [
        ...
        "Integrate Salesforce with other systems and applications using API",
        "Provide ongoing support and maintenance for Salesforce applications",
  ...
  certifications: [
    {
      id: 1,
      name: "Software Development and Specialization Training Program",
  ...
  projects: [
    {
      id: 1,
      name: "Salesforce Custom Solutions",
      description: "Enterprise Salesforce configurations and integrations",
    ...
    {
      id: 2,
      name: "Java Backend Services",
      description: "High-performance backend services and APIs",
      technologies: ["Java", "Spring Boot", "SQL", "REST APIs"],
      link: "https://github.com/example",
      image:
        "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=500&h=300&fit=crop",
      demoUrl: "https://example-api.com",
      caseStudy:
        "Built scalable Java backend services handling 100k+ daily requests with optimized database queries and caching strategies.",
    },
    {
      id: 3,
  ...
  portfolio: [
    {
      ...
      description:
        "Complete Salesforce implementation for enterprise organization",
      longDescription:
        "Designed and implemented enterprise-wide Salesforce solution including custom configurations, Apex development, Visualforce pages, and Lightning Web Components. Integrated with existing systems using APIs and managed complex data migrations.",
      ...
      testimonial:
        "Excellent Salesforce expertise and implementation. The solution exceeded our expectations.",
    ...
    },
    {
      ...
      description:
        "Building scalable microservices using Java and modern technologies",
      longDescription:
        "Architected and developed microservices-based backend system using Java Spring Boot, supporting multiple services with optimized database design, caching layer, and comprehensive API documentation.",
      category: "Backend Development",
      technologies: ["Java", "Spring Boot", "SQL", "Redis", "Docker"],
      image:
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=500&fit=crop",
      demoUrl: "https://example-services.com",
      githubUrl: "https://github.com/example",
      results: [
      ...
      testimonial:
        "Outstanding backend architecture. The system is reliable and performant.",
      client: "Tech Solutions Ltd.",
    },
    {
      id: 3,
      title: "Modern React Application Development",
      description:
        "Building responsive web applications with React and TypeScript",
      longDescription:
        "Developed comprehensive React web application with TypeScript, implementing modern UI patterns, state management, and optimized performance. Features include responsive design, dark mode support, and progressive enhancement.",
      category: "Frontend Development",
      technologies: ["React", "TypeScript", "Tailwind CSS", "Next.js"],
      image:
        "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=800&h=500&fit=crop",
      demoUrl: "https://example-react.com",
      githubUrl: "https://github.com/example",
      results: [
      ...
      testimonial:
        "Beautiful and performant React application. Great attention to detail.",
