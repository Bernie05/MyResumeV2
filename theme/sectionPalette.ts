export function getSectionPalette(isDarkMode: boolean) {
  ...
  return {
    ...
    sectionBackground: isDarkMode
      ? "linear-gradient(180deg, rgba(2, 6, 23, 0.94) 0%, rgba(4, 47, 46, 0.86) 100%)"
      : "linear-gradient(180deg, rgba(239, 246, 255, 0.9) 0%, rgba(255, 255, 255, 0.98) 100%)",
    surfaceBackground: isDarkMode
      ? "linear-gradient(145deg, rgba(15, 23, 42, 0.96) 0%, rgba(4, 47, 46, 0.92) 100%)"
    ...
    buttonGradient: `linear-gradient(135deg, ${primaryAccent}, ${secondaryAccent})`,
    buttonHoverGradient: `linear-gradient(135deg, ${secondaryAccent}, ${primaryAccent})`,
